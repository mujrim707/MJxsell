...
print "\n";
print $c[9]. " https://github.com/mujrim707/ ☠ ☺ ☻";
print "\n";
print $c[9]. "TO: https://www.snapchat.com/add/cmc.e or https://www.snapchat.com/add/flaah999";
print "\n";
print "\n";
print $c[5]. " -> ";
